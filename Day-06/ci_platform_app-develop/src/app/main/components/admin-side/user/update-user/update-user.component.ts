...
export class UpdateUserComponent implements OnInit, OnDestroy {
  ...
  updateForm: FormGroup = this._fb.group({}); // Initialize to avoid undefined
  ...
  ngOnInit(): void {
    ...
    const paramUserId = this._activateRoute.snapshot.paramMap.get('userId');
    this.userId = paramUserId ? paramUserId : '';
